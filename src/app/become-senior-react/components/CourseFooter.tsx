...
const CourseFooter = () => {
    ...
    return (
        <footer
            ...
            style={cssVariables}
            className="relative w-full  text-white overflow-hidden min-h-[650px] flex items-end pb-16"
        >
            ...
            <div className="relative z-20 w-full px-4 h-64 md:px-16 flex flex-col md:flex-row justify-end items-end text-center md:text-left space-y-4 md:space-y-0">
                <div className="w-full md:w-1/3 flex justify-center md:justify-start">
                    <p>We learn, We share, We grow</p>
                </div>
                <div className="w-full md:w-1/3 flex justify-center">
                    <p>Powered By Cộng đồng System Design Việt Nam</p>
                </div>
                <div className="w-full md:w-1/3 flex justify-center md:justify-end">
                    <p>sydexa@gmail.com <br /> 0971489013</p>
                </div>
            </div>
        </footer>
    );
